...
<body class="<?= $bodyClass ?>">
  ...
  <header class="sticky top-0">
    <nav class="flex justify-between items-center md:px-8 pr-0 pl-4 bg-black z-50">
      <a href="index.html" class="logo">Ancreo</a>

      <!-- Menu Desktop -->
      <ul class="hidden md:flex text20">
        <li class="relative py-8 transition-colors duration-300 hover:bg-gray-300 hover:text-black group">
          <a class="p-8" href="index.html">Accueil</a>
          <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[4rem] border-l-transparent border-r-[4rem] border-r-transparent border-b-[1.5rem] b-black opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
        </li>
        <li class="relative py-8 transition-colors duration-300 hover:bg-gray-300 hover:text-black group">
          <a class="p-8" href="#.html">Réalisation</a>
          <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[5rem] border-l-transparent border-r-[5rem] border-r-transparent border-b-[1.5rem] b-black opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
        </li>
        <li
    ...
    <section class="<?= $carousel ?>">
      ...
      <section class="<?= $carouselMobile ?>">
        <div class="<?= $card ?>" onclick="openModal('projet1', this)">
          <img src="assets/realSkateBoardCrop.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet2', this)">
          <img src="assets/portfolioSean.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet3', this)">
          <img src="assets/AncreoV1.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet4', this)">
          <img src="assets/steamLike.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet5', this)">
          <img src="assets/quizList.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet6', this)">
          <img src="assets/podly.png" class="<?= $card__image ?>">
        </div>
                
        <div class="<?= $card ?>" onclick="openModal('projet7', this)">
          <img src="assets/biblio.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet8', this)">
          <img src="assets/Atlas.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet9', this)">
          <img src="assets/Magic.png" class="<?= $card__image ?>">
        </div>

        <div class="<?= $card ?>" onclick="openModal('projet10', this)">
          <img src="assets/BgCollect.png" class="<?= $card__image ?>">
        </div>
      </section>
    </main>
